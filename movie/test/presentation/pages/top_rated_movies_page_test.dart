...
class TopRatedMoviesEventFake extends Fake implements TopRatedMovieEvent {}

class TopRatedMoviesStateFake extends Fake implements TopRatedMovieState {}
...
void main() {
  ...
  testWidgets('Page should display center progress bar when loading', (WidgetTester tester) async {
    when(() => mockTopRatedMoviesBloc.state).thenReturn(TopRatedMovieLoading());
  ...
  testWidgets('Page should display ListView when data is loaded', (WidgetTester tester) async {
    when(() => mockTopRatedMoviesBloc.state).thenReturn(TopRatedMovieHasData(testMovieList));
