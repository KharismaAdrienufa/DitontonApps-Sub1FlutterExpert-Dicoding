...
class TvShowsRecommendationsBloc
    extends Bloc<TvShowsRecommendationsEvent, TvShowsRecommendationsState> {
  final GetTvRecommendations _getTvRecommendations;

  TvShowsRecommendationsBloc(this._getTvRecommendations)
      : super(TvShowsRecommendationsEmpty()) {
